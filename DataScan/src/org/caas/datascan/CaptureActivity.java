...
import org.caas.zxing.camera.CameraManager;
import org.caas.zxing.decoding.CaptureActivityHandler;
import org.caas.zxing.decoding.InactivityTimer;
import org.caas.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.capture_titlebar);
	...
	public void clickInputBarcode(View v) {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (s.equals("")) {
			...
			if (found) {
				...
				Toast.makeText(this, "û���ҵ�", Toast.LENGTH_SHORT).show();
